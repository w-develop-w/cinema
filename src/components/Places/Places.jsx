...
//                             return (
//                                 <button key={index} className={`${styles.button} ${styles[colorBtn]}`} onClick={(event, keys) => {clickOnPlace(event, keys)}}>
//                                     {item}
//                                 </button>
//                             );
//                         });
